    ...
    internal class RavagerAClawRight : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (NPC.ai[0] == 0f)
            {
                ...
                float num660 = body.Center.X - vector79.X;
                float num661 = body.Center.Y - vector79.Y;
                num660 += 120f;
                num661 += 50f;
                ...
                {
                    NPC.rotation = 0f;
                    NPC.Center = body.Center + new Vector2(120f, 50f);
                    NPC.ai[1] += 1f;
            ...
            else if (NPC.ai[0] == 2f)
            {
                ...
                float num667 = body.Center.X - vector81.X;
                float num668 = body.Center.Y - vector81.Y;
                num667 += body.velocity.X;
                num668 += body.velocity.Y;
                num668 += 40f;
                num667 += 110f;
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            float drawPositionX = body.Center.X - center.X;
            float drawPositionY = body.Center.Y - center.Y;
            drawPositionY += 12f;
            drawPositionX += 28f;
            ...
            while (draw)
            {
                ...
                else
                {
                    ...
                    drawPositionX = body.Center.X - center.X;
                    drawPositionY = body.Center.Y - center.Y;
                    drawPositionY += 12f;
                    drawPositionX += 28f;
