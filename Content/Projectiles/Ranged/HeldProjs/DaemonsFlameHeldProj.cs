...
using CalamityWeaponRemake.Content.Projectiles.Magic;
...
namespace CalamityWeaponRemake.Content.Projectiles.Ranged.HeldProjs
{
    internal class DaemonsFlameHeldProj : ModProjectile
    {
        ...
        public void SpanProj()
        {
            ...
            {
                Owners.PickAmmo(Owners.ActiveItem(), out ArrowTypes, out scaleFactor11, out weaponDamage2, out weaponKnockback2, out _);
                ...
                else
                {
                    for (int i = 0; i < 4; i++)
                    {
                        Vector2 vr = Projectile.rotation.ToRotationVector2() * Main.rand.Next(20, 26);
                        Vector2 pos = Projectile.Center + Main.rand.NextVector2Unit() * 8;
                    ...
                    Projectile.NewProjectile(
                            ...
                            ModContent.ProjectileType<TheCurseArchdemon>(),
                            weaponDamage2 * 2,
                            weaponKnockback2,
                            Owners.whoAmI
                            );
        ...
        {
            Texture2D men = CWRUtils.GetT2DValue("CalamityMod/Projectiles/Ranged/DaemonsFlameBowGlow");
