...
namespace CalamityWeaponRemake.Content.Projectiles.Weapons.Melee.IridescentExcaliburpProj
{
    internal class IridescentExcaliburLight : ModProjectile
    {
        ...
        public override void AI() {
            if (projColor == Color.White) {
                projColor = CWRUtils.MultiLerpColor(Main.rand.NextFloat(), IridescentExcalibur.richColors);
            }
            if (owner != null)
