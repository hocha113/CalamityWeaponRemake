...
namespace CalamityWeaponRemake.Content.Projectiles.Magic
{
    internal class GhastlyBlasts : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int k = 0; k < 10; k++)
            {
                int num3 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 60, 0f, 0f, 0, default(Color), 2.7f);
            ...
            for (int l = 0; l < 10; l++)
            {
                int num4 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 60, 0f, 0f, 0, default(Color), 1.5f);
