...
namespace CalamityWeaponRemake.Common
{
    public static class CWRUtils
    {
        ...
        /// </summary>
        /// <returns>合法将返回 <see cref="true"/></returns>
        public static bool ValidateIndex(this List<int> ts, int index) => index >= 0 && index < ts.Count;
        ...
        /// </summary>
        /// <param name="spriteBatch">绘制模式</param>
        public static void ResetBlendState(this SpriteBatch spriteBatch) => spriteBatch.ModifyBlendState(BlendState.AlphaBlend);

        /// <summary>
        /// 将 <see cref="SpriteBatch"/> 的 <see cref="BlendState"/> 设置为 <see cref="BlendState.Additive"/>。
        /// </summary>
        /// <param name="spriteBatch">绘制模式</param>
        public static void SetAdditiveState(this SpriteBatch spriteBatch) => spriteBatch.ModifyBlendState(BlendState.Additive);
